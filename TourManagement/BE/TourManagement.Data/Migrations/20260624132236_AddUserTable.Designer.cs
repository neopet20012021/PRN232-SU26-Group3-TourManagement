...
namespace TourManagement.Data.Migrations
{
    ...
    [Migration("20260624132236_AddUserTable")]
            ...
            modelBuilder.Entity("TourManagement.Data.Models.Tour", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Category = "mien-bac",
                            ChildPrice = 1750000m,
                            CreatedDate = new DateTime(2026, 6, 24, 20, 22, 33, 481, DateTimeKind.Local).AddTicks(5371),
                            Days = 3,
                            DepartureDate = new DateTime(2026, 7, 4, 20, 22, 33, 481, DateTimeKind.Local).AddTicks(5397),
                        ...
                        new
                        {
                            ...
                            Category = "mien-bac",
                            ChildPrice = 2240000m,
                            CreatedDate = new DateTime(2026, 6, 24, 20, 22, 33, 481, DateTimeKind.Local).AddTicks(5410),
                            Days = 2,
                            DepartureDate = new DateTime(2026, 6, 29, 20, 22, 33, 481, DateTimeKind.Local).AddTicks(5414),
                        ...
                        new
                        {
                            ...
                            Category = "mien-trung",
                            ChildPrice = 3150000m,
                            CreatedDate = new DateTime(2026, 6, 24, 20, 22, 33, 481, DateTimeKind.Local).AddTicks(5417),
                            Days = 4,
                            DepartureDate = new DateTime(2026, 7, 9, 20, 22, 33, 481, DateTimeKind.Local).AddTicks(5421),
